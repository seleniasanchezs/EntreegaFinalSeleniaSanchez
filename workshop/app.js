...
async function ready() {
    ...
    // Capturamos el evento de envío del formulario de búsqueda
    document.getElementById('search-form').addEventListener('submit', function (event) {
        ...
        // Renderiza las cajas de productos filtrados en el HTML
        renderizarProductos(productosFiltrados);
    });

    // Obtener los datos de la API utilizando Fetch
    try {
        const response = await fetch('https://api.tuapiejemplo.com/data.json');
        if (!response.ok) {
...
function eliminarItemCarrito(event) {
    ...
    // Actualizamos el total delCarrito
    actualizarTotalCarrito();
...
function actualizarTotalCarrito() {
    ...
    for (var i = 0; i < carritoItems.length; i++) {
        ...
        // quita el símbolo peso y el punto de milesimos
...
// Aquí se encuentra el código para el formulario de búsqueda

function renderizarProductos(productos) {
    var contenedorItems = document.querySelector('.contenedor-items');
    contenedorItems.innerHTML = ''; // Limpia el contenido anterior
    ...
    productos.forEach(function (producto) {
        ...
        item.querySelector('.boton-item').addEventListener('click', function () {
